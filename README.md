...
#### Version 1
```
docker   build     --build-arg   JAR_FILE=target/devops_001_hello-1.0.0.jar       --tag  merdo9164/devops_001_hello:v001     .
```


#### Version 2
```
docker   build     --build-arg   JAR_FILE=target/devops_001_hello-1.0.2.jar       --tag  merdo9164/devops_001_hello:v002     .
```


#### Version 3
```
docker buildx  build     --build-arg   JAR_FILE=target/devops_001_hello-1.0.3.jar       --tag  merdo9164/devops_001_hello:v003     .
```
...
```
docker  run  -it  -d   -p  9091:8080     --name my-app1     merdo9164/devops_001_hello:v001
```
...
```
docker  run  -it  -d   -p  9092:8080     --name my-app2     merdo9164/devops_001_hello:v002
```
...
```
docker  run  -it  -d   -p  9093:8080     --name my-app3     merdo9164/devops_001_hello:v003
```
...
```
docker push merdo9164/devops_001_hello:v001
```

```
docker push merdo9164/devops_001_hello:v002
```

```
docker push merdo9164/devops_001_hello:v003
```
...
```
docker pull merdo9164/devops_001_hello:v001
```

```
docker pull merdo9164/devops_001_hello:v002
```

```
docker pull merdo9164/devops_001_hello:v003
```
...
```
docker pull merdo9164/devops_002_hello:v001
```

```
docker pull merdo9164/devops_002_hello:v002
```

```
docker pull merdo9164/devops_002_hello:v003
```